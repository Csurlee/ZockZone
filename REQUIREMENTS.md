...
| `/var/log/zockzone-chat/` | `[LINUX_USER]:www-data` | `775` | Chat-Log-Dateien |
| `/home/[LINUX_USER]/zockzone/bot/.env` | `[LINUX_USER]` | `600` | Bot-Zugangsdaten |
| `/var/www/zockzone/admin/includes/config.php` | `[LINUX_USER]:www-data` | `640` | Admin-Zugangsdaten |
